...
export default function PostList({ group, posts, onOpen }) {
  ...
  if (posts) {
    return (
      <div className="flex gap-6 overflow-x-auto px-6 py-8 mx-4 my-6 rounded-xl border-l-6 border-l-blue-500 border border-gray-200 bg-white/70 backdrop-blur-md shadow-md dark:border-gray-700 dark:bg-gray-800/60 dark:shadow-lg">
